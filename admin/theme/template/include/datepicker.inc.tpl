...
{combine_script id='jquery.ui.timepicker-addon' load=$load_mode require='jquery.ui.datepicker,jquery.ui.slider' path="admin/theme/js/ui/jquery.ui.timepicker-addon.js"}
