(function($) {
    ...
    $.fn.pwgDoubleSlider = function(options) {
        ...
        function onChange(e, ui) {
            ...
            that.find('.slider-info').html(sprintf(options.text, options.values[ui.values[0]], options.values[ui.values[1]]));
        }
        ...
        var values = [options.values.indexOf(options.selected.min), options.values.indexOf(options.selected.max)];
        if (values[0] == -1) {
