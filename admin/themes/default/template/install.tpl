...
<html lang="{$lang_info.code}" dir="{$lang_info.direction}">
  <head>
    ...
    {/if}
    {/foreach}
    <link rel="stylesheet" type="text/css" href="{$ROOT_URL}admin/themes/default/install.css">
    ...
    {combine_script id='jquery.cluetip' load='async' require='jquery' path='admin/themes/default/js/plugins/jquery.cluetip.js'}
