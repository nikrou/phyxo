  ...
  <table>
    ...
    <tr>
      ...
      <td class="pluginDesc" id="desc_{$plugin.ID}">
        ...
        <img src="{$themeconf.admin_icon_dir}/plus.gif" alt="" class="button_{$plugin.ID}">
        <img src="{$themeconf.admin_icon_dir}/minus.gif" alt="" class="button_{$plugin.ID}" style="display:none;">
