  ...
  <table>
    ...
    <tr>
      ...
      <td class="pluginDesc" id="desc_{$theme.ID}">
        ...
        <img src="{$themeconf.admin_icon_dir}/plus.gif" alt="" class="button_{$theme.ID}">
        <img src="{$themeconf.admin_icon_dir}/minus.gif" alt="" class="button_{$theme.ID}" style="display:none;">
