...
class TagMapper
{
    private $em, $conf, $image_std_params, $metadata;

    public function __construct(EntityManager $em, Conf $conf, ImageStandardParams $image_std_params, Metadata $metadata)
    {
        $this->em = $em;
        $this->conf = $conf;
