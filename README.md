...
![PHPSTan level](https://img.shields.io/badge/PHPStan-level%202-brightgreen.svg?style=flat)
...
The analysis is made with level 2 but the idea is to increase that level and fix more and more possible issues.
