...
$lang['Phyxo configuration'] = 'Phyxo設定';
...
$lang['A new version of Phyxo is available.'] = '新しいバージョンのPhyxoが利用可能です。';
$lang['Phyxo Administration'] = 'Phyxo管理';
$lang['Phyxo version'] = 'Phyxoバージョン';
$lang['You are running the latest version of Phyxo.'] = 'あなたは最新バージョンのPhyxoを使用しています。';
...
$lang['Visit Phyxo project website'] = 'Phyxo のホームページへ';
...
$lang['Update to Phyxo %s'] = 'Phyxo %s にアップグレード';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = 'Phyxo %sにアップグレードせずに、直接Phyxo %s にアップグレードすることができます（推進）。';
...
$lang['Phyxo Update'] = 'Phyxo をアップデート';
...
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = '次のプラグインは、Phyxoの最新版で使えない可能性があります。';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = '次のテーマは、Phyxoの最新版で使えない可能性があります。';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = '注意！このプラグインがこのPIWIGOのバージョンに合っていません。';
