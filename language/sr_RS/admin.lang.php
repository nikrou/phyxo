...
$lang['Phyxo configuration'] = 'Phyxo подешавања';
...
$lang['A new version of Phyxo is available.'] = 'Нова Phyxo vерзија је доступна.';
$lang['Phyxo Administration'] = 'Phyxo администрација';
$lang['Phyxo version'] = 'Phyxo верзија';
$lang['You are running the latest version of Phyxo.'] = 'Користите најновију верзију Phyxo-a.';
...
$lang['Create the "%s" directory at the root of your Phyxo installation'] = 'Направи "%s" дирецторијум у корену Ваше Phyxo инсталације';
$lang['Give write access (chmod 777) to "%s" directory at the root of your Phyxo installation'] = 'Дозволи упис (chmod 777) у "%s" директоријум у корену Ваше Phyxo инсталције';
...
$lang['Visit Phyxo project website'] = 'Посети страницу Phyxo пројекта';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = 'Упозорење! Овај додатак није компатибилан са овом верзијом Phyxo.';
...
$lang['Phyxo Update'] = 'ПиВиГо је унапређен';
$lang['Extensions Update'] = 'Додатаци су унапређени';
$lang['All extensions are up to date.'] = 'Сви додаци су ажурирани.';
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = 'Следећи додаци можда нису компатибилни са новом верзијом ПиВиГо-а:';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = 'Следеће теме можда нису компатибилне са новом верзијом ПиВиГо-а:';
$lang['I decide to update anyway'] = 'Одлучио сам да унапредим у сваком случају';
$lang['Update to Phyxo %s'] = 'Унапредите на ПиВиГо: %s';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = 'Можете унапредити ПиВиГо директно на %s, без унапређења ПиВиГо-а %s (препоручено).';
