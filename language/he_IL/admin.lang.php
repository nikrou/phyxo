...
$lang['Phyxo configuration'] = 'תצורה Phyxo';
...
$lang['A new version of Phyxo is available.'] = 'הגרסה החדשה של Phyxo זמין.';
$lang['Phyxo Administration'] = 'המינהל Phyxo';
$lang['Phyxo version'] = 'הגרסה Phyxo';
$lang['You are running the latest version of Phyxo.'] = 'אתה מפעיל את הגירסה העדכנית Phyxo.';
...
$lang['Create the "%s" directory at the root of your Phyxo installation'] = 'יצירת"%s "ספרייה בשורש של ההתקנה שלך Phyxo ';
$lang['Give write access (chmod 777) to "%s" directory at the root of your Phyxo installation'] = 'תן הרשאות (chmod 777) ל"%s" בתקיית שורש איפה שההתקנה שלך נמצאת';
...
$lang['Visit Phyxo project website'] = 'בקר באתר Phyxo פרוייקט';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = 'אזהרה! נראה כי תוסף זה לא מתאים ל Phyxo.';
...
$lang['display'] = 'הצג';
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = 'אתה יכול לעדכן ל Phyxo %s ישירות, מבלי לשדרג ל Phyxo %s (מומלץ).';
...
$lang['Phyxo Update'] = 'Phyxo עדכון';
$lang['Extensions Update'] = 'עדכון הרחבה';
$lang['All extensions are up to date.'] = 'כל ההרחבות מעודכנות.';
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = 'יכול להיות שההתקן לא תואם לגירסה החדשה של Phyxo:';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = 'יכול להיות שהערכת הנושא לא תואמת לגירסה החדשה של Phyxo:';
$lang['I decide to update anyway'] = 'החלתי לעדכן בכל מיקרה';
$lang['Update to Phyxo %s'] = 'עדכן ל Phyxo %s';
