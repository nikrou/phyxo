...
$lang['A new version of Phyxo is available.'] = '新版本的Phyxo已經可用';
$lang['Add'] = '新增';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = '您可直接升級到Phyxo的%s，而不需升級到Phyxo的%s（建議版本）';
