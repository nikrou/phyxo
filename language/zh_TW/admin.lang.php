...
$lang['Phyxo configuration'] = 'Phyxo的設定';
...
$lang['A new version of Phyxo is available.'] = '有新的 Phyxo 版本發佈';
$lang['Phyxo Administration'] = 'Phyxo管理';
$lang['Phyxo version'] = 'Phyxo版本';
$lang['You are running the latest version of Phyxo.'] = '你正在執行的是Phyxo最新版。';
...
$lang['Create the "%s" directory at the root of your Phyxo installation'] = '建立 "%" 在安裝Phyxo的根目錄下';
...
$lang['Visit Phyxo project website'] = '瀏覽 Phyxo 項目網站';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = '警告! 這個插件與此Phyxo版本不相容!';
...
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = '以下插件可能無法兼容新Phyxo的版本:';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = '以下主題可能無法兼容新版本Phyxo:';
...
$lang['Update to Phyxo %s'] = '更新到Phyxo %s';
$lang['Updates'] = '更新';
$lang['Width'] = '寬度';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = '您可直接升級到Phyxo的％s，而不需升級到Phyxo的％（建議版本）';
$lang['Zoom'] = '放大';
