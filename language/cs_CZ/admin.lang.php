...
$lang['Phyxo configuration'] = 'Nastavení aplikace Phyxo';
...
$lang['A new version of Phyxo is available.'] = 'Je dostupná nová verze Phyxo.';
$lang['Phyxo Administration'] = 'Administrace Phyxo';
$lang['Phyxo version'] = 'Verze Phyxo';
$lang['You are running the latest version of Phyxo.'] = 'Používáte nejnovější verzi Phyxo.';
...
$lang['Visit Phyxo project website'] = 'Navštívit Phyxo projektový web portál';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = 'POZOR! Tento plugin se zdá nekompatibilní s touto verzí Phyxo.';
...
$lang['Phyxo Update'] = 'Phyxo Aktualizace';
$lang['Extensions Update'] = 'Aktualizace Doplňků';
$lang['All extensions are up to date.'] = 'Veškerá rozšíření jsou aktuální.';
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = 'Následující pluginy nemusejí být kompatibilní s novou verzí Phyxo:';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = 'Následující šablony vzhledu nemusejí být kompatibilní s novou verzí Phyxo:';
$lang['I decide to update anyway'] = 'Rozhodl jsem se aktualizovat';
$lang['Update to Phyxo %s'] = 'Aktualizace na Phyxo %s';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = 'Můžete aktualizovat na vyšší verzi Phyxo %s přímo, bez nutnosti upgradu na Phyxo %s (doporučeno).';
