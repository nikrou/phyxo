...
$lang['Phyxo configuration'] = 'Phyxo配置';
...
$lang['ACCESS_5'] = '不开放';
$lang['A new version of Phyxo is available.'] = 'Phyxo新版发布。';
$lang['Phyxo Administration'] = 'Phyxo管理';
$lang['Phyxo version'] = 'Phyxo版本';
$lang['You are running the latest version of Phyxo.'] = '您运行的是Phyxo最新版。';
...
$lang['Visit Phyxo project website'] = '浏览 Phyxo 项目网站';
...
$lang['WARNING! This plugin does not seem to be compatible with this version of Phyxo.'] = '警告！此插件并不适用于这个版本的Phyxo。';
...
$lang['Phyxo Update'] = 'Phyxo更新';
$lang['Extensions Update'] = '扩展更新';
$lang['All extensions are up to date.'] = '所有扩展已更新。';
$lang['Following plugins may not be compatible with the new version of Phyxo:'] = '以下插件可能与新版 Phyxo 不兼容：';
$lang['Following themes may not be compatible with the new version of Phyxo:'] = '以下主题可能与新版 Phyxo 不兼容：';
$lang['I decide to update anyway'] = '仍决定更新';
$lang['Update to Phyxo %s'] = '更新到 Phyxo %s';
...
$lang['You can update to Phyxo %s directly, without upgrading to Phyxo %s (recommended).'] = '您可以直接更新到 Phyxo %s，不需先更新到 Phyxo %s（推荐）。';
