...
{combine_script id='jquery.selectize' load='footer' path='themes/legacy/js/plugins/selectize.min.js'}
{combine_css id='jquery.selectize' path="themes/legacy/js/plugins/selectize.{$themeconf.colorscheme}.css"}
...
{block name="content"}
   ...
   <script><!-- document.search.search_allwords.focus(); //--></script>
{/block}
