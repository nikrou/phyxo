...
$lang['number_of_albums'] = "{count, plural, =0 {aucun album} one {un album} other {# albums}}";
...
$lang['Activate icon "Show file metadata"'] = 'Activer l\'icône "Montrer les méta-données du fichier"';
$lang['Activate icon "Download this file"'] = 'Activer l\'icône "Télécharger ce fichier"';
$lang['Activate icon "Add this photo to your favorites"'] = 'Activer l\'icône "Ajouter cette photo à vos favoris"';
$lang['Activate icon "Display all photos in all sub-albums"'] = 'Activer l\'icône "Afficher à plat les photos des albums et des sous-albums"';
$lang['Activate icon "Display a calendar by creation date"'] = 'Activer l\'icône "Afficher un calendrier par date de création"';
$lang['Activate icon "Display a calendar by posted date"'] = 'Activer l\'icône "Afficher un calendrier par date d\'ajout"';
$lang['Activate icon "Display only recently posted photos"'] = 'Activer l\'icône "N\'afficher que les photos publiées récemment"';
$lang['Activate icon "new" next to albums and pictures'] = 'Afficher l\'icône "nouveau" à côté des albums et des photos';
$lang['Activate icon "Sort order"'] = 'Afficher l\'icône "Ordre de tri"';

$lang['Slideshow'] = 'Diaporama';
$lang['Number of albums per page'] = 'Nombre d\'albums par page';
$lang['The number of albums per page must be above 4'] = 'Le nombre d\'albums par page doit être supérieur à 4';
...
$lang['Your configuration settings have been updated'] = 'Vos paramètres de configuration ont été mis à jour';
...
$lang['Contact'] = 'Contacter';
$lang['Someone requested that the password be reset for theTurn photo to match what you want to see: following user account:'] = "Quelqu'un a demandé le renouvellement de votre mot de passe pour l'utilisateur suivant : ";
...
$lang['90° right'] = '90° dans le sens des aiguilles d\'une montre';
$lang['90° left'] = '90° dans le sens inverse des aiguilles d\'une montre';
$lang['180°'] = '180°';
$lang['Turn photo to match what you want to see:'] = "Tourner la photo pour la voir comme vous souhaitez : ";
$lang['Apply on original image'] = "Pivoter aussi l'image originelle";
